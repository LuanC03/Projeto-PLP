...
inserirBPC(Tabuleiro, NovoTabuleiro):- 
 ...
 Linha2 is Linha+1,Linha3 is Linha+2,Linha4 is Linha+3, ((Orientacao == 0) -> alteraValorNoTabuleiro(Tabuleiro, Linha, Coluna, b,  Tabuleiro2),alteraValorNoTabuleiro(Tabuleiro2, Linha, Coluna2, b, Tabuleiro3),alteraValorNoTabuleiro(Tabuleiro3, Linha, Coluna3, b,  Tabuleiro4),alteraValorNoTabuleiro(Tabuleiro4, Linha, Coluna4, b, NovoTabuleiro); 
